...
function loadSounds() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('number_sounds.json')];
                case 1:
                    res = _a.sent();
...
function createGrid(sounds) {
    ...
    var _loop_1 = function (i) {
        ...
        cell.addEventListener('click', function () { return speak(sounds[i.toString()]); });
        cell.addEventListener('touchstart', function () { return speak(sounds[i.toString()]); });
